  ...
  return (
    <div className={`relative inline-block ${className}`} ref={ref}>
      ...
      <button
        ...
        className={
          showText
            ? "flex items-center gap-2 px-4 py-3 border bg-white rounded-lg text-sm font-bold shadow-sm hover:bg-gray-50 text-gray-700 transition hover:cursor-pointer relative "
      ...
      {/* Dropdown */}
      {open && (
        <div className="absolute right-0 top-full mt-2 min-w-[8rem] text-[12px] rounded-xl bg-white border border-gray-200 text-black  overflow-hidden z-50">
