...
const PropertyCard = ({ project, isWishlisted, onToggleWishlist, onTourClick }) => {
  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-300  relative transition-all duration-300 ease-in-out hover:-translate-y-1 hover:shadow-xl hover:scale-[1.02] h-full mx-2 flex flex-col justify-between">
      {/* Top Image Section */}
