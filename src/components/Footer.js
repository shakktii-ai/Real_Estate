          ...
          <div>
            ...
            <div className="flex gap-4 mt-2">
              <a
                target="_blank"
                rel="noopener noreferrer"
                href="https://www.facebook.com/piinggaksha?mibextid=wwXIfr&rdid=l9Q3mSuaYX3pxaDO&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F1HY9VApXpE%2F%3Fmibextid%3DwwXIfr#"
              ...
              <a
                target="_blank"
                rel="noopener noreferrer"
                href="https://www.instagram.com/piinggaksha_?igsh=NWZpMmRwdzJ4NzVi&utm_source=qr"
                className="w-6 h-6 rounded-full border border-[#742E85] flex items-center justify-center text-[#742E85] hover:bg-[#742E85] hover:text-white transition-all shadow-sm"
              >
                <FaInstagram size={12} />
              </a>
