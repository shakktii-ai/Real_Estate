...
export default function BookVirtualTourModal({
    propertyId,
        ...
        <div className="fixed inset-0 z-[100] bg-black/50 flex items-center justify-center p-4">
            <div className="bg-white w-full max-w-[420px] rounded-2xl shadow-2xl relative p-6">
                ...
                <h2 className="text-md leading-none font-bold text-black mb-6">
                    Book a Virtual Project Tour
                </h2>

                {/* <p className="text-sm text-gray-500 mt-1 mb-6">{visit.propertyId?.projectName}</p> */}
                ...
                <div className="flex items-center justify-center mb-8">
                    {[1, 2, 3].map((item, index) => (
                        <div key={item} className="flex items-center">
                            <div
                                className={`w-10 h-10 rounded-full flex items-center justify-center text-sm font-semibold ${step > item
                            ...
                            {index !== 2 && (
                                <div
                                    className={`w-16 h-[2px] ${step > item ? "bg-[#E5097F]" : "bg-gray-200"
                                        }`}
                                />
                            )}
                        </div>
                        ...
                        <div className="space-y-5 mb-8">
                            {[
                                ...
                                },
                                {
                                    ...
                                    desc: "Receive confirmation email with Google Meet Link",
                                },
                                {
                                    title: "Join Virtual Tour",
                                    desc: "Connect at scheduled time and explore the property",
                                },
                            ].map((item, index) => (
                                ...
                                <div className="grid grid-cols-1 gap-2">
                                    {TIME_SLOTS.map((slot) => (
                                        <button
                                            ...
                                            className={`border rounded-lg px-3 py-2 text-xs transition ${formData.time === slot
                    ...
                    <>
                        ...
                        <div className="flex gap-3">
                            ...
                            <button
                                ...
                                disabled={loading}
                                className={`w-1/2 py-3 rounded-lg font-medium text-white ${loading
